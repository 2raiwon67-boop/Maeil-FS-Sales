...
const PRODUCT_IMAGE_MANUAL_MAP: Record<string, string> = {
  '매일 멸균 오리지널 1L': '매일 멸균 우유 오리지널 1L×10.webp',
  '상하목장 유기농우유 900ml': '상하목장 유기농 우유 900ml×12.webp',
  '베이커리치즈 1.8kg(100매)': '베이커리치즈1.8kg(100매)×5.webp',
  '베이커리치즈II 1.8kg(100매)': '베이커리치즈1.8kg(100매)×5.webp',
  '매일 휘핑크림 골드 1L': '매일 휘핑크림골드 1L.webp',
  '콰트로퐁듀 크림치즈 1kg': '콰트로퐁듀크림치즈1KG.webp',
  '체다슬라이스III 100매 1.8kg': '체다슬라이스III 100매 .webp',
  '테너 베이스 체리 1.2kg': '테너 베이스 체리.webp',
  '테너 베이스 클레멘타인 1.2kg': '테너 베이스 클레멘타인.webp',
  '매일 두유 99.9 950ml': '매일두유 99.9 950mL.webp',
  '상하목장 요거트 소프트믹스 OM3 1L': '상하목장 요거트 소프트믹스 OM3.webp',
  '상하목장 소프트믹스 OM10 1L': '상하목장소프트믹스OM10 1L.webp',
